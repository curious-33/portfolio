...
[Site](https://curious.uz) · [Book a call](https://curious.uz/cal) · [X](https://twitter.com/curi0us_33) · [GitHub](https://github.com/curious-33) · [LinkedIn](https://www.linkedin.com/in/curious/)

</div>

---

Work, writing in code, and a calendar — small, fast, and built to feel right.

| | |
| --- | --- |
| **Home** | Profile, about, GitHub activity, selected work |
| **Projects** | Hawk, The Edge, New Era Life, Partie, and more |
| **Book** | [curious.uz/cal](https://curious.uz/cal) |

Next.js 16 · React 19 · TypeScript · Tailwind CSS · Motion
